...
public class MainActivity extends AppCompatActivity {
    ...
    private void takePreview() {
        try {
            ...
            previewRequestBuilder.addTarget(mSuaceViewHolder.getSurface());
            // 创建CameraCaptureSession，该对象负责管理处理预览请求和拍照请求
            mCameraDevice.createCaptureSession(Arrays.asList(mSuaceViewHolder.getSurface(), mImageReader.getSurface()), new CameraCaptureSession.StateCallback() {
                @Override
